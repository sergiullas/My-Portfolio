        ...
        <Box sx={{ mt: theme.spacing(3) }}>
          <Box sx={{ mt: theme.spacing(2) }}>
            ...
            <Collapse in={showFederalPrograms} timeout="auto">
              <Stack id="federal-programs-panel" spacing={0.5} sx={{ mt: theme.spacing(1), pl: theme.spacing(0.5) }}>
                ...
                <Typography variant="body2">05/2016 – 07/2019 – USTP Project – Department of Justice (DoJ)</Typography>
                <Typography variant="body2">09/2017 – 07/2018 – JIDO Project – Department of Defense (DoD)</Typography>
                <Typography variant="body2">01/2016 – 09/2016 – D3 Project – Defense Intelligence Agency (DIA)</Typography>
                <Typography variant="body2">04/2015 – 10/2015 – SEVIS Project – Department of Homeland Security (DHS)</Typography>
                <Typography variant="body2">09/2013 – 10/2015 – OSCAR Project – Defense Intelligence Agency (DIA)</Typography>
                <Typography variant="body2">04/2014 – 10/2014 – COUGAR Project – Defense Intelligence Agency (DIA)</Typography>
                <Typography variant="body2">10/2013 – 03/2014 – Black Forest Project – Defense Intelligence Agency (DIA)</Typography>
                <Typography variant="body2">02/2013 – 08/2013 – CRATE Project – Defense Intelligence Agency (DIA)</Typography>
                <Typography variant="body2">08/2012 – 02/2013 – ICE CMM Project – Department of Homeland Security (DHS)</Typography>
                <Typography variant="body2">06/2010 – 08/2012 – DRAMRS Project – Director of National Intelligence (ODNI)</Typography>
                <Typography variant="body2">09/2009 – 06/2010 – ICE SEVIS II Project – Department of Homeland Security (DHS)</Typography>
                <Typography variant="body2">11/2008 – 09/2010 – RAMP Project – Department of Homeland Security (DHS)</Typography>
              </Stack>
            </Collapse>
          </Box>
        </Box>
